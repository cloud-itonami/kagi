...
```bash
kbb --backend sci scripts/verify-facts.cljk            # re-fetches every source; 0/1/2
kbb --backend sci scripts/mutation-check.cljk          # 14 structural mutations, no network
kbb --backend sci scripts/mutation-check.cljk --network  # + 6 paced fetching mutations
```
